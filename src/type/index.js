 ...
 * @name AssetBundle
 * @memberOf mCore.type
 * @property {mCore.type.ElementData[]} ui - Data that contain information about UI elements.
 * @property {mCore.type.AtlasInfo[]} atlases - atlases that use bundle;
 ...
 * @property {mCore.type.FontStyle[]} fontStyles - Array with font styles.
 * @property {mCore.type.AtlasFont[]} atlasFonts - Array with atlas font information.
 * @property {int[]} colors - Array of colors that use bundle.
 * @property {int[]} anchors - Array with anchor points.
 * @property {mCore.type.TextFieldStyle[]} textFieldStyles - Array with textField styles.
 * @property {string} name - Name of bundle.
 * @property {mCore.enumerator.BUNDLE_TYPE} bundleType - Type of  bundle that load.
 * @property {mCore.type.FontData[]} fontData - Array with information about fonts.
 ...
 * @property {mCore.enumerator.ui.HORIZONTAL_ALIGN[] | mCore.enumerator.ui.VERTICAL_ALIGN[]} align - Align of font (2 elements vertical and horizontal).
 ...
 * @name FontData
 * @memberOf mCore.type
 * @property {mCore.type.CharData[]} chars - Chars that use font.
 ...
 * @name AtlasInfo
 * @memberOf mCore.type
 * @property {mCore.type.AtlasFrame[]} frames - Array with frames of atlas.
 ...
 * @name AnimationFrame
 * @memberOf mCore.type
 * @property {mCore.enumerator.animation.ACTION_TYPE} type - type of frame.
 ...
 * @property {mCore.type.AnimationFrame[]} frames - Frames of animation.
 */
 ...
 * @property {mCore.enumerator.ui.UI_ELEMENT} type - Type of element to parse.
 ...
 * @property {mCore.type.ElementData[]} children - Child elements of element.
 * @property {mCore.type.ElementData} content - Content elements of element (FRor button title, For slider ball etc.).
 * @property {int[] | mCore.enumerator.DIRECTION[] | mCore.enumerator.ui.SCROLL_DIRECTION[] | mCore.enumerator.ui.PANEL_GRAPHIC_TYPE[]} fileData - Index of custom data to parse (For button textures, for label font style etc.).
 ...
 * @property {mCore.type.AnimationData[] | null} animations - Animations that use element.
 * @property {boolean[] | null } stretch - is stretch enabled.
 * @property {mCore.enumerator.ui.VERTICAL_ALIGN[] | mCore.enumerator.ui.HORIZONTAL_ALIGN[] | null} edge - Edge of element.
 ...
 * @namespace mCore.view.callback
 * @memberOf mCore.view
 */

/**
 * @desc Namespace with callbacks for components
 * @namespace mCore.component.callback
 ...
 * @memberOf mCore.component.callback
 */
 ...
 * @param {*} data
 * @memberOf mCore.animation.callback
 */
 ...
 * @param {mCore.type.AtlasInfo} atlas - Atlas that use texture.
 */
